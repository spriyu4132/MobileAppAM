...
public class FragmentBraceletGridAdapter extends RecyclerView.Adapter<FragmentBraceletGridAdapter.ViewHolder> {
  //  private final Context context;

    private final ArrayList<Product> products;
    private final BraceletFragment listener;
    private BraceletFragment braceletFragment;

    public FragmentBraceletGridAdapter(BraceletFragment braceletFragment, ArrayList<Product> products, BraceletFragment listener)
    {
        this.braceletFragment = braceletFragment;
        this.products = products;
        this.listener = listener;
    }

    public interface BraceletFragment
    {
...
//    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        Ion.with((androidx.fragment.app.Fragment) this.braceletFragment)
                .load(url)
                .withBitmap()
