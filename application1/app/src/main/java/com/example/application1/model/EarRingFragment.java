...
public class EarRingFragment extends Fragment implements FragmentEarGridAdapter.EarRingFragment
{
    RecyclerView recyclerView;
    FragmentEarGridAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        RecyclerView recyclerView = (RecyclerView) rootView.findViewById(R.id.earrecyclerView);

        FragmentActivity frag=getActivity();
       // FragmentEarGridAdapter adapter=new FragmentEarGridAdapter();

        adapter = new FragmentEarGridAdapter(this, products, this);
    ...
    private void loadProducts() {
        ...
        String url = Utils.createUrl(Constants.ROUTE_EARRING_PRODUCT);
