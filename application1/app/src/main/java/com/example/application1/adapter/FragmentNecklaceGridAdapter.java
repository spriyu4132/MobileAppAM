...
public class FragmentNecklaceGridAdapter extends RecyclerView.Adapter<FragmentNecklaceGridAdapter.ViewHolder> {
  //  private final Context context;

    private final ArrayList<Product> products;
    private final NecklaceFragment listener;
    private NecklaceFragment necklaceFragment;

    public FragmentNecklaceGridAdapter(NecklaceFragment necklaceFragment, ArrayList<Product> products, NecklaceFragment listener)
    {
        this.necklaceFragment = necklaceFragment;
        this.products = products;
        this.listener = listener;
    }

    public interface NecklaceFragment
    {
...
//    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        Ion.with((androidx.fragment.app.Fragment) this.necklaceFragment)
                .load(url)
                .withBitmap()
