...
import com.example.application1.adapter.FragmentEarGridAdapter;
...
public class RingFragment extends Fragment implements FragmentRingGridAdapter.RingFragment
{
    RecyclerView recyclerView;
    FragmentRingGridAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        View rootView = inflater.inflate(R.layout.fragment_ring, container, false);

        RecyclerView recyclerView = (RecyclerView) rootView.findViewById(R.id.ringrecyclerView);

        FragmentActivity frag=getActivity();
        // FragmentEarGridAdapter adapter=new FragmentEarGridAdapter();

        adapter = new FragmentRingGridAdapter(this, products, this);
    ...
    private void loadProducts() {
        ...
        String url = Utils.createUrl(Constants.ROUTE_RING_PRODUCT);
