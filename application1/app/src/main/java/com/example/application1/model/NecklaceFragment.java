...
import com.example.application1.adapter.FragmentNecklaceGridAdapter;
...
public class NecklaceFragment extends Fragment implements FragmentNecklaceGridAdapter.NecklaceFragment
{
    RecyclerView recyclerView;
    FragmentNecklaceGridAdapter adapter;
    ArrayList<Product> products = new ArrayList<>();
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View rootView = inflater.inflate(R.layout.fragment_necklace, container, false);

        RecyclerView recyclerView = (RecyclerView) rootView.findViewById(R.id.necklacerecyclerView);

        FragmentActivity frag=getActivity();
        // FragmentEarGridAdapter adapter=new FragmentEarGridAdapter();

        adapter = new FragmentNecklaceGridAdapter(this, products, this);
        ...
        //return inflater.inflate(R.layout.fragment_necklace,container,false);
    }
    ...
    private void loadProducts() {
        ...
        String url = Utils.createUrl(Constants.ROUTE_NECKLACE_PRODUCT);
